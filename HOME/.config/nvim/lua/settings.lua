...
-- Resize
vim.cmd('nnoremap <silent> <C-j> :resize -2<CR>')
vim.cmd('nnoremap <silent> <C-k> :resize +2<CR>')
vim.cmd('nnoremap <silent> <C-h> :vertical resize -2<CR>')
vim.cmd('nnoremap <silent> <C-l> :vertical resize +2<CR>')
-- Bufferline
